...
The number of facets of $\mathscr P_n$ is $2^n-2$.

(equations of facets?)

ABHY conditions:
\bea
C_I = (-1)^{|I|} \left( \sum_{i \in I} X_i - \sum _{{i<j}\atop{i,j \in I}} X_{ij} +\cdots + (-1)^{|I|+1}  X_I \right) \nonumber
\eea
...
Then we can then solve for the corresponding $u's$ :
\bea
