...
(cluster configuration space, perfect u eqs)
...
Each facet of $P_n$ is lebeled by a non-empty proper subset $I$ of $[0,n]$, whose
equation is 
\begin{equation}
...
(proof of equations fo facets or ABHY condition?)

To get $u$-equations, we should solve $S_J$ by $F_J$ for eq.(\theequation), the 
solution is 
\[
