...
\eea
From the above relations it is clear that taking $u_I \rightarrow 0$ for $0 \notin I$ implies $x_J \rightarrow 0$ for all $J \subset I$ and taking $u_\bar{I} \rightarrow 0$ for $0 \in I$ implies $x_J \rightarrow \infty $ for all $I \subset J$.
In fact we shall argue that there is unique choice of $x_I$'s which we can take to $0$ or $\infty$ which corresponds to setting a particular $u_I \rightarrow 0$ or $u_\bar{I} \rightarrow 0$ respectively.
...
We shall prove $\mathscr P_{n+1}$ is binary by showing that whenever we take some $u_I \rightarrow 0$ (by taking a unique set of $x_i \rightarrow 0, \infty$) then $u_J \rightarrow 1$ for $J$ incompatible with $I$ and the remaining $u$'s reduce to the $u$'s corresponding to $\matchscr P_k \times \mathscr P_{n-k}$. 

It is enough to consider $u_1, u_{12},\cdots,u_{12...n(n+1)} \rightarrow 0$ and  $u_0, u_{0(n+1)},u_{0,n(n+1)}\cdots,u_{02...n(n+1)} \rightarrow 0$.

We have the following cases:
\begin{enumerate}
    \item $u_I \rightarrow 0$ with $0\notin I$ and $|I| < \lfloor \frac{n+1}{2} \rfloor$ i.e $I = \{ \{1\},\{1,2\},\cdots,\{1,2,\cdots, \lfloor \frac{n+1}{2} \rfloor -1 \} \}$
    
    In this case we take $x_i \rightarrow t x_i$ for $i=1,\cdots \lfloor \frac{n+1}{2} \rfloor$ and consider the limit $t \rightarrow 0$ to give:
    \bea
    u^{(n+1)}_{J \cup  I} &\rightarrow& u_{J}^{((n+1)-|I|)} ~\text{with}~ J\subseteq\bar{I}\\
     u^{(n+1)}_{K} &\rightarrow& u_{K}^{(|I|-1)} ~\text{with}~ K\subsetneq I
    \eea
   which gives $\mathscr P_{(n+1)-|I|} \times \mathscr P_{|I|-1}$ 
    
    
    \item $u_I \rightarrow 0$ with $0\notin I$ and $|I| \ge \lfloor \frac{n+1}{2} \rfloor$ i.e. $I = \{\{1,2,\cdots, \lfloor \frac{n+1}{2} \rfloor\},\cdots,\{1,2,\cdots, (n+1) \} \}$
     In this case we take $x_i \rightarrow t x_i$ for $i=1,\cdots \lfloor \frac{n+1}{2} \rfloor-1$ and $x_{\lfloor \frac{n+1}{2} \rfloor} \rightarrow t$ and  consider the limit $t \rightarrow 0$ to give:
    \bea
    u^{(n+1)}_{J } &\rightarrow& u_{J}^{((n+1)-|I|)} ~\text{with}~ J\subseteq \{1,\cdots,|I|-1\}\\
     u^{(n+1)}_{J \cup \{|I|\}} &\rightarrow& u_{K \cup\{0\}}^{((n+1)-|I|)} ~\text{with}~ J\subsetneq I\{1,\cdots,|I|-1\}
    \eea
     \bea
    u^{(n+1)}_{K \cup I } &\rightarrow& u_{J}^{(|I|-1)} ~\text{with}~ K\subseteq \{|I|+1,\cdots,n+1\}\\
     u^{(n+1)}_{K \cup \{0\}\cup I} &\rightarrow& u_{K \cup{0}}^{(|I|-1)} ~\text{with}~ K\subsetneq I\{|I|+1,\cdots,n+1\}
    \eea
   which gives $\mathscr P_{(n+1)-|I|} \times \mathscr P_{|I|-1}$ 
    \item $u_I \rightarrow 0$ with $0\in I$ and $|I| < \lfloor \frac{n+1}{2} \rfloor$ i.e. $I = \{\{0\},\{0,(n+1)\},\cdots,\{0,\lfloor \frac{n+1}{2} \rfloor+2,\cdots,(n+1)\}$
    In this case we take $x_i \rightarrow \frac{ x_i}{t}$ for $i=1,\cdots \lfloor \frac{n+1}{2} \rfloor$ and $x_{\lfloor \frac{n+1}{2}+1 \rfloor} \rightarrow \frac{1}{t}$ and  consider the limit $t \rightarrow 0$ to give:
    \item $u_I \rightarrow 0$ with $0\in I$ and $|I| \ge \lfloor \frac{n+1}{2} \rfloor$ i.e. $I = \{\{0,\lfloor \frac{n+1}{2} \rfloor+1,\cdots,(n+1)\},\cdots,\{0,2,\cdots,(n+1)\} \}$
    In this case we take $x_i \rightarrow \frac{ x_i}{t}$ for $i=1,\cdots \lfloor \frac{n+1}{2} \rfloor$ and $x_{\lfloor \frac{n+1}{2}+1 \rfloor} \rightarrow \frac{1}{t}$ and  consider the limit $t \rightarrow 0$ to give:
\end{enumerate}
