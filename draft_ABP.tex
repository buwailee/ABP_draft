...
The direct proof of this argument for $\mathscr A_n$ is using the global $u$-equations of $\mathscr A_n$. ...

(Find all with perfect $u$-eq?)

The story of degenerations of $B_n$ is very similar. The first thing to do is to find degenerations whose big polytopes are simplices.
