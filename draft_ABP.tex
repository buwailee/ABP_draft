...
Suppose $\mathscr D$ is the set of all vanishing facets in the building set, we can read from the mesh that
\[
...
\]
for any $I\not\in \mathscr D$. 
%From the viewpoint of mesh, the product are taken over all diamonds whose $c$s are all zero, top (respectively, bottom) corner is a deleted element $I'$, bottom (respectively, top) corner is 0 and left or right corner is $I$, because for such diamond $F_{I'}=F_I+\cdots$ or $M^I_{I'}=1$.
...
so 
\begin{align*}
\tilde u_{1}&=u_1 u_{123} u_{12}=\frac{x_1x_{012}}{x_{12}x_{01}}\frac{x_{123}}{x_{0123}}\frac{x_{12}x_{0123}}{x_{123}x_{012}}=\frac{x_1}{x_{01}},\\
\tilde u_{2}&=u_2 u_{123} u_{12}u_{23}=\frac{x_2x_{123}}{x_{23}x_{12}}\frac{x_{123}}{x_{0123}}\frac{x_{12}x_{0123}}{x_{123}x_{012}}\frac{x_{23}}{x_{123}}=\frac{x_{2}}{x_{012}},\dots
\end{align*}
