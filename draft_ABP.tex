...
\usepackage{amsfonts,amssymb,amsmath,mathtools,empheq,amsthm,hyperref,graphicx,paralist}
...
{\Large \bf Stringy canonical forms and binary geometries from associahedra, cyclohedra and generalized permutohedra}
...
\end{tikzpicture}
\end{center}
\caption{Compatible\textbackslash incompatible facets of the 2d associahedron (a) and permutohedron (b) as generalized permutohedra}
\end{figure}
...
In this paper we introduced a large class of integrals,  ${\cal I}_{\bf B}$, which can be regarded as a family of rigid stringy canonical forms%~\cite{Arkani-Hamed:2019mrd} 
